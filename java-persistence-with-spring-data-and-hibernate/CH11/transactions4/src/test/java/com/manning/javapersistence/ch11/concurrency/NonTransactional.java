...
public class NonTransactional {
    ...
    @Test
    public void autoCommitVersion1() {
      Long ITEM_ID;
...
//       em.flush();
      ...
      */
      ...
      {
        em = emf.createEntityManager();
        Item newItem = new Item("New Name");
        em.persist(newItem);

        assertNotNull(newItem.getId());
        Long NEW_ITEM_ID = newItem.getId();
    ...
    public void autoCommit() {
        ...
        // Reading data in auto-commit mode
        {
            ...
            assertEquals(
                    "New Name",
                    em.createQuery("select i from Item i where i.id = :id", Item.class) // return from persistence context
