...
public class DatabaseGeneratedPropertyValue {
  @Test
  void testDBAutogeneratedPropertyValue() {
    ...
    try {
      ...
      System.out.println(items.get(0).getLastModified());
      items.get(0).setName("After Update Name");
      ...
      System.out.println(items.get(0).getCreatedOn());
      System.out.println(items.get(0).getLastModified());
